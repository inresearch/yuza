...
RSpec.describe Api::UsersController, type: :controller do
  ...
  describe 'PUT #update' do
    ...
    it 'can update data' do
      ...
      put :update, params: {user: {name: 'Akira'}, id: User.first.id, host: {secret: host.secret}}
    ...
    context 'invalid data' do
      it 'fails gracefully when password too short' do
        put :update, params: {password: {password: 'a', app: 'pageok'}, id: User.first.id, host: {secret: host.secret}}
        expect(parsed_body).to eq({
          success: false,
